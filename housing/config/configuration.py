from housing.entity.config_entity import DataIngetionConfig, DataValidationConfig, DataTransformationConfig, ModelTrainerConfig, ModelEvaluationConfig, ModelPusherConfig, TrainingPipelineConfig
...
class Configuration:
    ...
    def get_data_ingestion_config(self) -> DataIngetionConfig:
        try:
            ...
            dataset_download_dir = data_ingestion_info[DATASET_DOWNLOAD_URL_KEY]
            ...
            data_ingestion_config = DataIngetionConfig(dataset_download_dir=dataset_download_dir,
