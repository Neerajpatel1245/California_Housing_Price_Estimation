...
class ModelTrainer:
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            ...
            logging.info("Initializing model factory class using above model config file: {model_config_file_path}")
            ...
            logging.info("Best model found on training dataset: {best_model}")
